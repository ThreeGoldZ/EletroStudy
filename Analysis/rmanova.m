...
for i=1:120
    if  data(i,4)==1
        loc1_min=[loc1_min data(i,7)]
    end
    if  data(i,4)==2
        loc2_min=[loc2_min data(i,7)]
    end
    if  data(i,4)==3
        loc3_min=[loc3_min data(i,7)]
    end
    if  data(i,4)==4
        loc4_min=[loc4_min data(i,7)]
    end
    if  data(i,4)==5
        loc5_min=[loc5_min data(i,7)]
    end
    if  data(i,4)==6
        loc6_min=[loc6_min data(i,7)]
    end
end

for i=1:120
    if  data(i,4)==1
        loc1_max=[loc1_max data(i,8)]
    end
    if  data(i,4)==2
        loc2_max=[loc2_max data(i,8)]
    end
    if  data(i,4)==3
        loc3_max=[loc3_max data(i,8)]
    end
    if  data(i,4)==4
        loc4_max=[loc4_max data(i,8)]
    end
    if  data(i,4)==5
        loc5_max=[loc5_max data(i,8)]
    end
    if  data(i,4)==6
        loc6_max=[loc6_max data(i,8)]
    end
end
